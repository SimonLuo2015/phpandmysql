            ...
            <tr>
                ...
                <td bgcolor="#cccccc" align="right">
                    ...
                    <a href="new_post.php?parent=<?php echo $post['postid']; ?>">
                        <img src="images/reply.gif" border=0 width=99 height=39 alt="">
                    </a>
                    <a href="index.php?expanded=<?php echo $post['postid']; ?>">
                        <img src="images/index.gif" border=0 width=99 height=39 alt="">
                    </a>
                </td>
            </tr>
            <tr>
        ...
        <table cellpadding=0 cellspacing=0 border=0 width=<?php echo $table_width; ?>>
            <form action="store_new_post.php?expand=<?php echo $parent;?>#<?php echo $parent;?>" method="post">
                <tr>
                    ...
                    <td bgcolor="#cccccc">
                        <input type="text" name="poster" value="<?php echo $poster; ?>" size=20 maxlength=20>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#cccccc">
                ...
                <tr>
                    <td colspan=2>
                        <textarea name="message" cols="55" rows="10">
